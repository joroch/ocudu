...
public:
  ...
  void operator()(coro_context<async_task<gnb_cu_ue_f1ap_id_t>>& ctx);
...
private:
  ...
  gnb_cu_ue_f1ap_id_t create_ue_context_release_complete();
  ...
  gnb_cu_ue_f1ap_id_t release_result = gnb_cu_ue_f1ap_id_t::invalid;
