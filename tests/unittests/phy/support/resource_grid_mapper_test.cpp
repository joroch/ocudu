...
// Tests mapping for one layer to eight one-dimensional antenna ports configuration, generated by the function
// make_one_layer_eight_ports_type1_sp_mode1.
TEST_F(ResourceGridMapperFixture, OneLayerEightPorts4x1)
{
  constexpr unsigned nof_layers = 1;
  ...
  for (unsigned i_beam = 0; i_beam != 16; ++i_beam) {
    for (unsigned i_pol_phase = 0; i_pol_phase != 4; ++i_pol_phase) {
      // Initialize grid to zero.
      grid->set_all_zero();
      ...
      // Create a single layer to four ports precoding configuration.
      precoding_configuration precoding_config =
          precoding_configuration::make_wideband(make_one_layer_eight_ports_type1_sp_mode1(i_beam, i_pol_phase));
...
// Tests mapping for one layer to eight two-dimensional antenna ports configuration, generated by the function
// make_one_layer_eight_ports_type1_sp_mode1.
TEST_F(ResourceGridMapperFixture, OneLayerEightPorts2x2)
{
  constexpr unsigned nof_layers = 1;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 8; ++i_beam) {
    for (unsigned i_beam_2 = 0; i_beam_2 != 8; ++i_beam_2) {
      for (unsigned i_pol_phase = 0; i_pol_phase != 4; ++i_pol_phase) {
        // Initialize grid to zero.
        grid->set_all_zero();
        ...
        // Create a single layer to four ports precoding configuration.
        precoding_configuration precoding_config = precoding_configuration::make_wideband(
            make_one_layer_eight_ports_type1_sp_mode1(i_beam, i_beam_2, i_pol_phase));
...
// Tests mapping for two layers to eight one-dimensional antenna ports configuration, generated by the function
// make_two_layer_eight_ports_type1_sp_mode1.
TEST_F(ResourceGridMapperFixture, TwoLayerEightPorts4x1)
{
  constexpr unsigned nof_layers = 2;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 16; ++i_beam) {
    for (unsigned i_beam_offset = 0; i_beam_offset != 4; ++i_beam_offset) {
      for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
        // Initialize grid to zero.
        grid->set_all_zero();

        // Create a two layer to eight ports precoding configuration.
        precoding_configuration precoding_config = precoding_configuration::make_wideband(
            make_two_layer_eight_ports_type1_sp_mode1(i_beam, i_beam_offset, i_pol_phase));
...
// Tests mapping for two layers to eight two-dimensional antenna ports configuration, generated by the function
// make_two_layer_eight_ports_type1_sp_mode1.
TEST_F(ResourceGridMapperFixture, TwoLayerEightPorts2x2)
{
  constexpr unsigned nof_layers = 2;
  constexpr unsigned nof_ports  = 8;
    ...
    for (unsigned i_beam_2 = 0; i_beam_2 != 8; ++i_beam_2) {
      for (unsigned i_beam_offset = 0; i_beam_offset != 4; ++i_beam_offset) {
        for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
          ...
          // Create a two layer to eight ports precoding configuration.
          precoding_configuration precoding_config = precoding_configuration::make_wideband(
              make_two_layer_eight_ports_type1_sp_mode1(i_beam, i_beam_2, i_beam_offset, i_pol_phase));
...
// Tests mapping for three layers to eight one-dimensional antenna ports configuration, generated by the function
// make_three_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, ThreeLayerEightPorts4x1)
{
  constexpr unsigned nof_layers = 3;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 16; ++i_beam) {
    for (unsigned i_beam_offset = 0; i_beam_offset != 3; ++i_beam_offset) {
      for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
        // Initialize grid to zero.
        grid->set_all_zero();

        // Create a three layer to eight ports precoding configuration.
        precoding_configuration precoding_config = precoding_configuration::make_wideband(
            make_three_layer_eight_ports_type1_sp(i_beam, i_beam_offset, i_pol_phase));
...
// Tests mapping for three layers to eight two-dimensional antenna ports configuration, generated by the function
// make_three_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, ThreeLayerEightPorts2x2)
{
  constexpr unsigned nof_layers = 3;
  constexpr unsigned nof_ports  = 8;
    ...
    for (unsigned i_beam_2 = 0; i_beam_2 != 8; ++i_beam_2) {
      for (unsigned i_beam_offset = 0; i_beam_offset != 3; ++i_beam_offset) {
        for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
          ...
          // Create a three layer to eight ports precoding configuration.
          precoding_configuration precoding_config = precoding_configuration::make_wideband(
              make_three_layer_eight_ports_type1_sp(i_beam, i_beam_2, i_beam_offset, i_pol_phase));
...
// Tests mapping for four layers to eight one-dimensional antenna ports configuration, generated by the function
// make_four_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, FourLayerEightPorts4x1)
{
  constexpr unsigned nof_layers = 4;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 16; ++i_beam) {
    for (unsigned i_beam_offset = 0; i_beam_offset != 3; ++i_beam_offset) {
      for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
        ...
        // Create a four layer to eight ports precoding configuration.
        precoding_configuration precoding_config = precoding_configuration::make_wideband(
            make_four_layer_eight_ports_type1_sp(i_beam, i_beam_offset, i_pol_phase));
...
// Tests mapping for four layers to eight two-dimensional antenna ports configuration, generated by the function
// make_four_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, FourLayerEightPorts2x2)
{
  constexpr unsigned nof_layers = 4;
  constexpr unsigned nof_ports  = 8;
    ...
    for (unsigned i_beam_2 = 0; i_beam_2 != 8; ++i_beam_2) {
      for (unsigned i_beam_offset = 0; i_beam_offset != 3; ++i_beam_offset) {
        for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
          ...
          // Create a four layer to eight ports precoding configuration.
          precoding_configuration precoding_config = precoding_configuration::make_wideband(
              make_four_layer_eight_ports_type1_sp(i_beam, i_beam_2, i_beam_offset, i_pol_phase));
...
// Tests mapping for five layers to eight one-dimensional antenna ports configuration, generated by the function
// make_five_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, FiveLayerEightPorts4x1)
{
  ...
  for (unsigned i_beam = 0; i_beam != 16; ++i_beam) {
    for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
      ...
      // Create a five layer to eight ports precoding configuration.
      precoding_configuration precoding_config =
          precoding_configuration::make_wideband(make_five_layer_eight_ports_type1_sp(i_beam, i_pol_phase));
...
// Tests mapping for five layers to eight two-dimensional antenna ports configuration, generated by the function
// make_five_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, FiveLayerEightPorts2x2)
{
  constexpr unsigned nof_layers = 5;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 8; ++i_beam) {
    for (unsigned i_beam_2 = 0; i_beam_2 != 8; ++i_beam_2) {
      for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
        ...
        // Create a five layer to eight ports precoding configuration.
        precoding_configuration precoding_config =
            precoding_configuration::make_wideband(make_five_layer_eight_ports_type1_sp(i_beam, i_beam_2, i_pol_phase));
...
// Tests mapping for six layers to eight one-dimensional antenna ports configuration, generated by the function
// make_six_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, SixLayerEightPorts4x1)
{
  constexpr unsigned nof_layers = 6;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 16; ++i_beam) {
    for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
      ...
      // Create a six layer to eight ports precoding configuration.
      precoding_configuration precoding_config =
          precoding_configuration::make_wideband(make_six_layer_eight_ports_type1_sp(i_beam, i_pol_phase));
...
// Tests mapping for six layers to eight two-dimensional antenna ports configuration, generated by the function
// make_six_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, SixLayerEightPorts2x2)
{
  constexpr unsigned nof_layers = 6;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 8; ++i_beam) {
    for (unsigned i_beam_2 = 0; i_beam_2 != 8; ++i_beam_2) {
      for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
        ...
        // Create a six layer to eight ports precoding configuration.
        precoding_configuration precoding_config =
            precoding_configuration::make_wideband(make_six_layer_eight_ports_type1_sp(i_beam, i_beam_2, i_pol_phase));
...
// Tests mapping for seven layers to eight one-dimensional antenna ports configuration, generated by the function
// make_seven_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, SevenLayerEightPorts4x1)
{
  ...
  for (unsigned i_beam = 0; i_beam != 8; ++i_beam) {
    for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
      ...
      // Create a seven layer to eight ports precoding configuration.
      precoding_configuration precoding_config =
          precoding_configuration::make_wideband(make_seven_layer_eight_ports_type1_sp(i_beam, i_pol_phase));
...
// Tests mapping for seven layers to eight two-dimensional antenna ports configuration, generated by the function
// make_seven_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, SevenLayerEightPorts2x2)
{
  constexpr unsigned nof_layers = 7;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 8; ++i_beam) {
    for (unsigned i_beam_2 = 0; i_beam_2 != 8; ++i_beam_2) {
      for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
        ...
        // Create a seven layer to eight ports precoding configuration.
        precoding_configuration precoding_config = precoding_configuration::make_wideband(
            make_seven_layer_eight_ports_type1_sp(i_beam, i_beam_2, i_pol_phase));
...
// Tests mapping for eight layers to eight one-dimensional antenna ports configuration, generated by the function
// make_eight_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, EightLayerEightPorts4x1)
{
  constexpr unsigned nof_layers = 8;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 8; ++i_beam) {
    for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
      ...
      // Create an eight layer to eight ports precoding configuration.
      precoding_configuration precoding_config =
          precoding_configuration::make_wideband(make_eight_layer_eight_ports_type1_sp(i_beam, i_pol_phase));
...
// Tests mapping for eight layers to eight two-dimensional antenna ports configuration, generated by the function
// make_eight_layer_eight_ports_type1_sp.
TEST_F(ResourceGridMapperFixture, EightLayerEightPorts2x2)
{
  constexpr unsigned nof_layers = 8;
  constexpr unsigned nof_ports  = 8;
  ...
  for (unsigned i_beam = 0; i_beam != 8; ++i_beam) {
    for (unsigned i_beam_2 = 0; i_beam_2 != 8; ++i_beam_2) {
      for (unsigned i_pol_phase = 0; i_pol_phase != 2; ++i_pol_phase) {
        ...
        // Create an eight layer to eight ports precoding configuration.
        precoding_configuration precoding_config = precoding_configuration::make_wideband(
            make_eight_layer_eight_ports_type1_sp(i_beam, i_beam_2, i_pol_phase));
