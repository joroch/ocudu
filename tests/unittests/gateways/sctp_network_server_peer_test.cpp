...
protected:
  ...
  sctp_network_server_config server_cfg1{{}, broker1, io_rx_executor, ctrl_executor, assoc_factory1};
  sctp_network_server_config server_cfg2{{}, broker2, io_rx_executor, ctrl_executor, assoc_factory2};
  sctp_network_server_config server_cfg3{{}, broker3, io_rx_executor, ctrl_executor, assoc_factory3};
