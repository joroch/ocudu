...
template <>
void interleave_layers_simd<2>(span<cf_t> out, simd_cf_t in[2])
{
...
template <>
void interleave_layers_simd<4>(span<cf_t> out, simd_cf_t in[4])
{
...
template <>
void interleave_layers_simd<2>(span<float> out, simd_f_t in[2])
{
...
template <>
void interleave_layers_simd<4>(span<float> out, simd_f_t in[4])
{
