...
void measurement_procedure::send_ul_nrppa_pdu(const asn1::nrppa::nr_ppa_pdu_c& meas_init_outcome)
{
  // Pack into PDU.
  ul_nrppa_pdu = pack_into_pdu(
      meas_init_outcome,
      meas_init_outcome.type().value == asn1::nrppa::nr_ppa_pdu_c::types_opts::successful_outcome ? "MeasResponse"
                                                                                                  : "MeasFailure");

  // Log Tx message.
  log_nrppa_message(logger, Tx, ul_nrppa_pdu, meas_init_outcome);

  // Send response to CU-CP.
  cu_cp_notifier.on_ul_nrppa_pdu(ul_nrppa_pdu, amf_index);
}

asn1::nrppa::nr_ppa_pdu_c measurement_procedure::create_measurement_failure(nrppa_cause_t cause)
{
...
inline asn1::nrppa::relative_path_delay_c relative_path_delay_to_asn1(const relative_path_delay_t& relative_path_delay)
{
...
inline asn1::nrppa::trp_meas_quality_c trp_meas_qualitiy_to_asn1(const trp_meas_quality_t& trp_meas_quality)
{
...
inline asn1::nrppa::multiple_ul_ao_a_item_c
...
inline asn1::nrppa::add_path_list_item_s add_path_list_item_to_asn1(const add_path_list_item_t& add_path_list_item)
{
...
inline asn1::nrppa::extended_add_path_list_item_s
