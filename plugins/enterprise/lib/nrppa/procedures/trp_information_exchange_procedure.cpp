...
void trp_information_exchange_procedure::send_ul_nrppa_pdu(const asn1::nrppa::nr_ppa_pdu_c& meas_init_outcome)
{
  // Pack into PDU.
  ul_nrppa_pdu = pack_into_pdu(
      meas_init_outcome,
      meas_init_outcome.type().value == asn1::nrppa::nr_ppa_pdu_c::types_opts::successful_outcome ? "TRPInfoResponse"
                                                                                                  : "TRPInfoFailure");
...
asn1::nrppa::nr_ppa_pdu_c trp_information_exchange_procedure::create_trp_info_failure(nrppa_cause_t cause)
{
