...
asn1_to_relative_cartesian_location(const asn1::f1ap::relative_cartesian_location_s& asn_location);
...
trp_information_failure_t f1ap_trp_information_exchange_procedure::create_trp_info_failure(const f1ap_cause_t& cause)
{
...
trp_information_response_t
f1ap_trp_information_exchange_procedure::create_trp_info_response(const asn1::f1ap::trp_info_resp_s& asn1_resp)
{
