...
#include "f1ap/cu_cp/f1ap_asn1_helpers.h"
#include "f1ap/f1ap_asn1_utils.h"
...
inline asn1::f1ap::ref_sig_c ref_sig_to_asn1(const spatial_relation_info_t::reference_signal& ref_sig)
{
