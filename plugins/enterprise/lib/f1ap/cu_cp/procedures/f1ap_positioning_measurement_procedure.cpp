...
#include "f1ap/cu_cp/f1ap_asn1_converters.h"
...
f1ap_positioning_measurement_procedure::create_positioning_measurement_failure(const f1ap_cause_t& cause)
{
...
inline trp_meas_quality_t asn1_to_trp_meas_quality(const asn1::f1ap::trp_meas_quality_s& asn1_trp_meas_quality)
{
...
std::vector<multiple_ul_aoa_item_t> asn1_to_multiple_ul_aoa(const asn1::f1ap::multiple_ul_ao_a_s& asn1_multiple_aoa)
{
...
measurement_response_t f1ap_positioning_measurement_procedure::create_positioning_measurement_response(
    const asn1::f1ap::positioning_meas_resp_s& asn1_resp)
{
...
inline asn1::f1ap::srs_configuration_s srs_configuration_to_asn1(const srs_configuration_t& srs_cfg)
{
