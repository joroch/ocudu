...
#include "du/procedures/proc_logger.h"
...
{
public:
  positioning_information_exchange_procedure(const asn1::f1ap::positioning_info_request_s& msg_,
...
void positioning_information_exchange_procedure::send_response() const
{
  using namespace asn1::f1ap;
...
async_task<void> odu::start_positioning_exchange_procedure(const asn1::f1ap::positioning_info_request_s& msg,
                                                           ...
                                                           f1ap_du_ue&                                   ue)
{
  return launch_async<positioning_information_exchange_procedure>(msg, du_mng.get_positioning_handler(), ue);
}
