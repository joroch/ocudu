...
uint8_t pucch_power_controller::compute_tpc_command(slot_point pucch_slot)
{
  ...
  const float sinr_to_target_f2_f3_diff = pucch_f2_f3_target_sinr_dB - pucch_f2_f3_f4_sinr_dB.get_average_value();
  ...
  if (format_set_0 == pucch_format::FORMAT_0) {
    const float sinr_to_target_f0_diff = pucch_f0_sinr_target_dB - pucch_f0_f1_sinr_dB.get_average_value();
