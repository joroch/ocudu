...
odu::start_positioning_measurement_procedure(const du_positioning_meas_request&     req,
                                             du_cell_manager&                       du_cells,
                                             du_ue_manager&                         ue_mng,
                                             const du_manager_params&               du_params,
                                             const std::map<trp_id_t, du_trp_info>& trps)
{
  return launch_async<positioning_measurement_procedure>(req, du_cells, ue_mng, du_params, trps);
}
