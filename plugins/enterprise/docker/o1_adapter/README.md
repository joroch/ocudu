...
Basic Python-based application that acts as an O1 adapter for OCUDU.
In a k8s deployment it's supposed to be running as a sidecar container to the e.g. OCUDU DU to control the config file generation/provisioning and livecycle of the Pod through a shared volume and REST-based API, respectivly.
