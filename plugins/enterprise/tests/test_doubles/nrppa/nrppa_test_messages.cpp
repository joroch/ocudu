...
#include "nrppa/nrppa_asn1_converters.h"
...
inline asn1::nrppa::srscfg_s generate_srscfg()
{
...
byte_buffer
ocudu::ocucp::generate_valid_nrppa_measurement_request(lmf_meas_id_t                        lmf_meas_id,
