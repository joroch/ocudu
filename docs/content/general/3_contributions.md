<a id="general-contributions"></a>

# Contribution Guidelines

Contributions to srsRAN Project are always welcome. The easiest way to contribute is by issuing a pull request on the [srsRAN Project repository](https://github.com/srsran/srsran_project). Take a look at our [code style guide](../../dev_guide/source/code_guide/source/index.md#code-guide-overview) and please follow our [testing policy](../../dev_guide/source/testing_policy/source/index.md#testing-policy).
