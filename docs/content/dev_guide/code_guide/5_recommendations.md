...
Avoid using the `long` type since it can be either 32 or 64-bits depending on the architecture. See the [standard definition](https://en.cppreference.com/w/cpp/language/types) for more information.
