...
![image](dev_guide/source/software_arch/source/DU_low/source/.imgs/DU_low.png)
...
is specific to ORAN Split 7.2. You can read more about split 7.2 [here](../../../../../../knowledge_base/source/oran_gnb/source/index.md#split) .
